#!/bin/bash
# Complete setup and benchmark execution script for EC2

set -e

echo "=========================================="
echo "GraphRAG Neptune Benchmark Setup"
echo "=========================================="
...
# Create neptune_data_loader.py
echo "Step 2: Creating neptune_data_loader.py..."
cat > /home/ec2-user/neptune_data_loader.py << 'ENDOFPYTHON'
#!/usr/bin/env python3
...
chmod +x /home/ec2-user/neptune_data_loader.py

# Create benchmark script
echo "Step 3: Creating neptune_opensearch_benchmark.py..."
cat > /home/ec2-user/neptune_opensearch_benchmark.py << 'ENDOFPYTHON'
#!/usr/bin/env python3
...
try:
    ...
    with open('/home/ec2-user/neptune_opensearch_results.json', 'w') as f:
        json.dump(results, f, indent=2)

    print("📁 Results saved to: /home/ec2-user/neptune_opensearch_results.json")
    print("\n✅ BENCHMARK COMPLETE!")
...
chmod +x /home/ec2-user/neptune_opensearch_benchmark.py

# Run Neptune data loader
echo ""
echo "=========================================="
echo "Step 4: Loading data to Neptune..."
echo "=========================================="
cd /home/ec2-user
...
echo ""
echo "=========================================="
echo "Step 5: Running two-layer benchmark..."
echo "=========================================="
...
echo "Final Results:"
echo "=========================================="
cat /home/ec2-user/neptune_opensearch_results.json

echo ""
echo "✅ ALL DONE! Results saved to /home/ec2-user/neptune_opensearch_results.json"
